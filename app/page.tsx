  ...
  return (
    <>
      <nav className="nav">
        <div className="container nav-inner">
          <div className="nav-left">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24" fill="none" aria-hidden>
            ...
            <span className="brand-text">Ship faster with Continuous AI</span>
          </div>
          <div className="nav-links">
            <a className="link" href="#solutions">Solutions</a>
          ...
          <div className="nav-cta">
            ...
            <a className="btn" href="https://github.com/continuedev/continue" target="_blank" rel="noreferrer">GitHub</a>
      ...
      <main>
        <section className="hero">
          <div className="container hero-inner">
            <h1>Continue — Ship faster with Continuous AI</h1>
            <p>Build and run custom agents across your IDE, terminal, and CI.</p>
        ...
        <section id="solutions" className="section">
          <div className="container">
            <h2>Solutions</h2>
            <p className="muted">End-to-end coding agents across your tools and workflows.</p>
          </div>
        </section>
        ...
        <section id="pricing" className="section">
          <div className="container">
            <h2>Pricing</h2>
            <p className="muted">Simple, scalable plans for teams of any size.</p>
          </div>
        </section>
        ...
        <section id="docs" className="section">
          <div className="container">
            <h2>Docs</h2>
            <p className="muted">Learn how to build, run, and share custom agents.</p>
          </div>
        </section>
        ...
        <section id="about" className="section">
          <div className="container">
            <h2>About Us</h2>
            <p className="muted">We’re building the future of developer agents.</p>
          </div>
        </section>
      </main>
      ...
      <footer className="footer">
        <div className="container">
          <div>© {new Date().getFullYear()} Continue</div>
          <div className="small">Next.js UI implemented without external public assets.</div>
        </div>
      </footer>
    </>
  );
